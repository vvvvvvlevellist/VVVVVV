...
export default {
            ...
            <div class="list-container">
                <table class="list" v-if="legacyList">
                    <tr v-for="([level, err], i) in legacyList">
                        <td class="rank">
                            <p class="type-label-sm type-legacy-rank">Legacy {{ i + 1 }}</p>
                        </td>
    ...
    computed: {
        level() {
            return this.legacyList[this.selected][0];
        },
        video() {
    ...
    async mounted() {
        ...
        // Extract legacy levels (index 50 onwards, which are rank 51+)
        this.legacyList = this.list.slice(50);
